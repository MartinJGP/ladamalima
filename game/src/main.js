...
function showComplete(r){
  ...
  const w=modal("¡Nivel completado!",`<div class="result-score">${r.score}</div><p>Bono por tiempo y vidas: ${r.bonus}</p><button id="next-level">SIGUIENTE NIVEL</button>`,"MENÚ PRINCIPAL",()=>renderMenu(),false);
