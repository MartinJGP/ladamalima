...
export const LEVELS = [
  {
    ...
    enemies: [{x:680,type:"guard"},{x:1340,type:"pigeon"},{x:2050,type:"guard"},{x:2780,type:"pigeon"}], hazards: [{x:950,w:82},{x:2440,w:95}], goal: {x:3440,y:365}
  },
  {
    ...
    enemies: [{x:560,type:"guard"},{x:1100,type:"pursuer"},{x:1750,type:"pigeon"},{x:2380,type:"guard"},{x:3060,type:"pursuer"}], hazards: [{x:810,w:140},{x:2050,w:150},{x:3330,w:105}], goal: {x:3860,y:365}
  },
  {
    ...
    enemies: [{x:520,type:"pursuer"},{x:1080,type:"pigeon"},{x:1600,type:"guard"},{x:2180,type:"pursuer"},{x:2750,type:"pigeon"},{x:3370,type:"guard"},{x:3900,type:"pursuer"}], hazards: [{x:740,w:120},{x:1290,w:100},{x:1850,w:150},{x:2460,w:145},{x:3300,w:130}], goal: {x:4250,y:335}
  }
];
